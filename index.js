...
app.get('/sessions', function(req,res){
	...
	MongoClient.connect(url, function(e, db) {
		...
		dbd.collection(combined_sessions_collection).find({"completed": true, "article_id": ObjectId('60454fe5906d053c3fa1a568')}).sort({_id: -1}).toArray(async function(err, results) {
			if (err) throw err;
			//console.log(results)
